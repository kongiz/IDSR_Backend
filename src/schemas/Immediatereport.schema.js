...
exports.immediateReportSchema = z.object({
  ...
  dateSeen:             z.string().min(1, "Date seen is required").refine(d => !isNaN(new Date(d).getTime()), "Invalid date seen"),
  dateFacilityNotified: z.string().min(1, "Date facility notified is required").refine(d => !isNaN(new Date(d).getTime()), "Invalid date facility notified"),
  ...
  age: z.union([z.string(), z.number()]).optional()
    ...
    .refine(v => v === null || !isNaN(v), "Age must be numeric"),
