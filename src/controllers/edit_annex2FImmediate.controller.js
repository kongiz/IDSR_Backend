...
exports.editImmediateReport = async (req, res) => {
  ...
  try {
    ...
    await client.query(
      `INSERT INTO report_edit_logs (report_id, report_type, edited_by, previous_data, new_data)
       VALUES ($1, $2, $3, $4, $5)`,
      [reportId, "ANNEX2F IMMEDIATE CASE REPORT", user.id, JSON.stringify(report), JSON.stringify(data)]
    );
    ...
    logger.error("editImmediateReport Error:", { error: error.message, stack: error.stack });
