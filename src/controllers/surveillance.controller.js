...
exports.submitSurveillanceReport = async (req, res) => {
  ...
  try {
    ...
    const allowedRoles = ["Health Officer", "Clinician", "Community Health Worker"];
    ...
    logger.info("Jurisdiction check:", {
      ...
      data_region:   data.region_id,
      user_district: user.district_id,
      data_district: data.district_id
    });
    ...
    const epiweek = data.epiweek || getEpiWeek(new Date());
    ...
    const reportResult = await client.query(
      `INSERT INTO surveillance_reports (
        ...
        tot_con_a5_male, tot_con_a5_female, officer_comment,
    ...
    await client.query("ROLLBACK");
    logger.error("submitSurveillanceReport Error:", { error: error.message, stack: error.stack });
